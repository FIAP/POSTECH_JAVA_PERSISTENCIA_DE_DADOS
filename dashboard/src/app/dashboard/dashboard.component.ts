...
export class DashboardComponent implements OnInit {
  ...
  teachers: { nome: string; email: string; telefone: string; curso: string; }[];
  // events
  ...
  ngOnInit() {
    ...
    this.getDashData();
    this.getTotalNewClients();
    this.getTotalSendAccess();
    this.getTotalTestsDone();
    this.getTeacher();
  }

  getTeacher() {  

    this._dashService.getTeacher().subscribe(data => {
      this.teachers = data;
    });
  }
  ...
  getTotalTestsDone() {
    ...
    this._dashService.getTotalTestsDone().subscribe(data => {
  ...
  getTotalSendAccess() {
    ...
    this._dashService.getTotalSendAccess().subscribe(data => {
      data.forEach(element => {
        result.push(element[1])
      });
    });
  ...
  getTotalNewClients() {
    ...
    this._dashService.getTotalNewClients().subscribe(data => {
      data.forEach(element => {
        result.push(element[1])
      });
    });
